...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'tiendavirtual'),
        'USER': os.getenv('MYSQL_USER', 'tienda'),
        'PASSWORD': os.getenv('MYSQL_PASSWORD', 'Adavid02'),
...
# WhiteNoise storage backend para producción
